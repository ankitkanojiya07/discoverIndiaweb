                ...
                <li key={link.path} className="relative">
                  {link.hasDropdown ? (
                    ...
                    >
                      ...
                      {showDestinations && (
                        <div className="absolute left-0 mt-2 py-2 w-48 bg-white shadow-lg rounded-md overflow-hidden">
                          {locations.map((dest) => (                              <Link
                                key={dest.name}
                ...
                <li key={link.path}>
                  {link.hasDropdown ? (
                    <div>
                      ...
                      >
                        {link.name}
                        <ChevronDown size={14} className={`ml-1 transform transition-transform ${showDestinations ? 'rotate-180' : ''}`} />
                      </button>
                      {showDestinations && (
                          ...
                          {locations.map((dest) => (
                            <li key={dest.name}>
                              <Link
                                ...
                                } hover:${isScrolled ? 'text-black' : 'text-white'}`}
                              >
                                {dest.name}
                              </Link>
                            </li>
